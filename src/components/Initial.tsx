...
export function Initial(){
	return(
		<Box w="100vw" h="100vh" backgroundSize={["180vh","180vh","180vh","180vw"]} backgroundRepeat="no-repeat" backgroundPosition="center" backgroundImage="/img/backgroundInitial.svg">
			<Center w="100%" h="100%" flexFlow="column">
				...
				<ButtonGroup spacing={[ 0, 6]} colorScheme="blue" display={["flex", 'block']} flexDirection="column">
					<Button as={HashLink} to="/ponto" mb={['1rem', '0']}>Encontrar um ponto</Button>
